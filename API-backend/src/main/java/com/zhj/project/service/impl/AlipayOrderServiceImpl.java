...
import com.zhj.common.model.alipay.AliPayAsyncResponse;
...
import com.zhj.common.model.enums.AlipayTradeStatusEnum;
...
import com.zhj.project.config.AliPayAccountConfig;
...
public class AlipayOrderServiceImpl extends ServiceImpl<ProductOrderMapper, ProductOrder> implements ProductOrderService {
    ...
    public ProductOrderVo saveProductOrder(Long productId, UserVO loginUser) {
        ...
        productOrder.setPayType(PayTypeStatusEnum.ALIPAY.getValue());
